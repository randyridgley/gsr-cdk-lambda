...
public class KafkaClickstreamClient {
    ...
    public static Integer numThreads = 2;
    ...
    public static long startingGlobalSeqNo = 0;
    ...
    private void runProducer() throws Exception {
        ...
        final Producer<String, ClickEvent> kafkaProducer = new KafkaProducerFactory(
          propertiesFilePath, sslEnable, mTLSEnable, saslscramEnable, 
          glueSchemaRegistry).createProducer();
